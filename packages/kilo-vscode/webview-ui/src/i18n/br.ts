...
export const dict = {
  ...
  "settings.sandboxing.allowedHosts.description":
    "Hosts e portas HTTPS exatos que o sandbox pode acessar. O GitHub CLI normalmente precisa de github.com:443 e api.github.com:443. As alterações valem para novas sessões.",
