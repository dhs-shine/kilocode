...
export const dict = {
  ...
  "settings.agentBehaviour.maxSteps.description":
    "الحد الأقصى لعدد خطوات الوكيل. عند بلوغ الحد، تُعطّل الأدوات ويقدم الوكيل استجابة نهائية. زِد القيمة للمهام المعقدة متعددة الخطوات، وخفّضها لجعل الاستجابات أقصر وأسهل في التنبؤ.",
