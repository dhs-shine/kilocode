...
export const dict = {
  ...
  "settings.agentBehaviour.maxSteps.description":
    "Максимальное количество шагов агента. При достижении лимита инструменты отключаются, и агент даёт окончательный ответ. Увеличьте для сложных многоэтапных задач; уменьшите, чтобы ответы были короче и предсказуемее.",
