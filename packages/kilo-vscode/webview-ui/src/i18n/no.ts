...
export const dict = {
  ...
  "settings.sandboxing.allowedHosts.description":
    "Nøyaktige HTTPS-verter og porter som sandkassen kan bruke. GitHub CLI trenger vanligvis github.com:443 og api.github.com:443. Endringer gjelder for nye økter.",
