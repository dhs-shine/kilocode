...
export const dict = {
  ...
  "settings.sandboxing.allowedHosts.description":
    "Præcise HTTPS-værter og porte, som sandkassen må tilgå. GitHub CLI kræver normalt github.com:443 og api.github.com:443. Ændringer gælder for nye sessioner.",
