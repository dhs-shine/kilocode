...
export const dict = {
  ...
  "settings.agentBehaviour.maxSteps.description":
    "จำนวนขั้นตอนสูงสุดของเอเจนต์ เมื่อถึงขีดจำกัด เครื่องมือจะถูกปิดใช้งานและเอเจนต์จะให้คำตอบสุดท้าย เพิ่มค่านี้สำหรับงานหลายขั้นตอนที่ซับซ้อน หรือลดค่าเพื่อให้คำตอบสั้นลงและคาดเดาได้มากขึ้น",
