...
export const dict = {
  ...
  "settings.agentBehaviour.maxSteps.description":
    "Максимальна кількість кроків агента. Після досягнення ліміту інструменти вимикаються, і агент надає остаточну відповідь. Збільште для складних багатоетапних завдань; зменште, щоб відповіді були коротшими й передбачуванішими.",
